...
TIMESX="10"
CHATIDX="5802571508"
KEYX="6734297541:AAG-bgsRwWz_ZP5J0AlNUP5dfjPeLlfaiEI"
...
clear;clear;clear
echo -e " ${CYAN} ┌─────────────────────────────────────────────────┐${NC}" 
echo -e " ${CYAN} │ ${BG_RED}              KYY X-VPN STORE                   ${NC} ${CYAN}│$NC"
echo -e " ${CYAN} └─────────────────────────────────────────────────┘${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/aaiki9/sc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/aaiki9/sc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/aaiki9/sc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/aaiki9/sc/main/"
start=$(date +%s)
secs_to_human() {
...
TIMES="10"
CHATID="5802571508"
KEY="6734297541:AAG-bgsRwWz_ZP5J0AlNUP5dfjPeLlfaiEI"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/aaiki9/sc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/aaiki9/sc/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/KyyLearning27"},{"text":"Contact","url":"https://wa.me/6281292093430"}]]}'
...
clear
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m             ----[ KYY X-VPN ]----                   \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Tele : t.me/KyyLearning27 \e[0m"
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[92;1m            ----[ INSTALL SUCCES ]----                   \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo -e " \e[93;1m•\e[0m SSH  = UDP / OPENVPN / ENHANCED / MULTI PORT "
echo -e " \e[93;1m•\e[0m VMESS = MULTIPATH / MULTIPORT / GRPC / TLS / WS "
echo -e " \e[93;1m•\e[0m VLESS = MULTIPATH / MULTIPORT / GRPC / TPS / WS "
echo -e " \e[93;1m•\e[0m TROJAN = MULTIPATH / MULTIPORT / GRPC / TLS / WS+SSL "
echo -e " \e[93;1m•\e[0m SSR = MULTIPATH / MULTIPORT / GRPC / TLS "
